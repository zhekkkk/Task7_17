...
public class GraphDemoFrame extends JFrame {
    ...
    public GraphDemoFrame() {
        ...
        buttonSolution.addActionListener(e -> {
            try {
                if (graph == null) {
                    return;
                }
                showSystemOut(() -> {
                    System.out.println(GraphAlgorithms.solution(graph));
                });
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textAreaGraphFile.setText("10 12 0 5 4 3  0 1  1 3  2 5  4 5 5 6 0 2  0 7  7 8  8 9  6 9 ");
        ...
        buttonSolution.setText("solution");
        panel6.add(buttonSolution, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
